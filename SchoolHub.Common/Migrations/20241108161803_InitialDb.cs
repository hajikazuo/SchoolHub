        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateDeleted = table.Column<DateTime>(type: "datetime2(2)", nullable: true),
                    DateRegistration = table.Column<DateTime>(type: "datetime2(2)", nullable: false),
                    LastModificationDate = table.Column<DateTime>(type: "datetime2(2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassGroups_Tennants_TennantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Tennants_TennantId",
                        column: x => x.TennantId,
                        principalTable: "Tennants",
                        principalColumn: "TennantId");
                });
